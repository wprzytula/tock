...
#[cfg(feature = "ieee")]
const RF_CMD_ACK_HANDLER: unsafe extern "C" fn() = crate::ieee802154_radio::rfc_cmd_ack_handler;
#[cfg(not(feature = "ieee"))]
const RF_CMD_ACK_HANDLER: unsafe extern "C" fn() = CortexM3::GENERIC_ISR;
...
static IRQS: [unsafe extern "C" fn(); 34] = [
    ...
    RF_CMD_ACK_HANDLER,       // RF Core Command Acknowledge
