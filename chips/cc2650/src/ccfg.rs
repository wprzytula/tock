...
mod ccfg_data {
    ...
    mod defaults {
        ...
        pub(super) const DEFAULT_CCFG_MODE_CONF: u32 = ((SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_DELTA
            ...
            & ((SET_CCFG_MODE_CONF_RTC_COMP << CCFG_MODE_CONF_RTC_COMP_S)
            ...
            & ((SET_CCFG_MODE_CONF_HF_COMP << CCFG_MODE_CONF_HF_COMP_S)
            ...
            & ((SET_CCFG_MODE_CONF_VDDR_CAP << CCFG_MODE_CONF_VDDR_CAP_S)
        ...
        pub(super) const DEFAULT_CCFG_BL_CONFIG: u32 = ((SET_CCFG_BL_CONFIG_BOOTLOADER_ENABLE
            ...
            & ((SET_CCFG_BL_CONFIG_BL_LEVEL << CCFG_BL_CONFIG_BL_LEVEL_S)
        ...
        pub(super) const DEFAULT_CCFG_CCFG_TAP_DAP_1: u32 =
            ((SET_CCFG_CCFG_TAP_DAP_1_PBIST2_TAP_ENABLE
                ...
                & ((SET_CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE
                    << CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE_S)
                    | !CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE_M);

        pub(super) const DEFAULT_CCFG_IMAGE_VALID_CONF: u32 =
            ((SET_CCFG_IMAGE_VALID_CONF_IMAGE_VALID << CCFG_IMAGE_VALID_CONF_IMAGE_VALID_S)
